...
tic;
visualizeObjWithColor('model\modeling_3d\6U_CubeSat_v7_nopayload\6U_CubeSat_v7_nopayload.obj');
fprintf('Loading time: %.2f seconds\n', toc);

%% 3. 3U CNU CubeSat 시각화
fprintf('\nLoading 3U CNU CubeSat...\n');
tic;
visualizeObjWithColor('model\modeling_3d\1015_3U_CNU\1015_3U_CNU.obj');
fprintf('Loading time: %.2f seconds\n', toc);
...
subplot(1,2,1);
tic;
[obj6U, mat6U, matAssign6U] = readObjWithCache('model\modeling_3d\6U_CubeSat_v7_nopayload\6U_CubeSat_v7_nopayload.obj');
...
subplot(1,2,2);
tic;
[obj3U, mat3U, matAssign3U] = readObjWithCache('model\modeling_3d\1015_3U_CNU\1015_3U_CNU.obj');
